        ...
        extend: {
            colors: {
                ...
                braun: {
                    ...
                    material: 'hsl(var(--braun-material))',
                    draft1: 'hsl(var(--braun-draft1))',
                    draft2: 'hsl(var(--braun-draft2))',
                    final: 'hsl(var(--braun-final))',
                    'text-primary': 'hsl(var(--braun-text-primary))',
                    'text-secondary': 'hsl(var(--braun-text-secondary))',
                    'text-tertiary': 'hsl(var(--braun-text-tertiary))'
                }
            },
            borderRadius: {
                lg: 'var(--radius)',
